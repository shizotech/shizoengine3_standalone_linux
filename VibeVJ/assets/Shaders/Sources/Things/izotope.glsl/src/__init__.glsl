...
//@enum options=(No Stripes, Horz Stripes, Vert Stripes)
uniform int make_stripes;

//@slider
uniform float stripe_offset;

//@float min=0.0 max=100.0 value=25.0
uniform float numParticles;

//@float min=0.0 max=100.0 value=5.0
uniform float numRings;

//@float min=0.0 max=100.0 value=30.0
uniform float offsetMult;

uniform float tau = 6.23813;
