...
// iChannelTime is not auto-added by the engine, define it manually
uniform float iChannelTime[3];
...
#define getLevel(x) (texelFetch(iChannel0, ivec2(int(x*512.), 0), 0).r*2.5)
